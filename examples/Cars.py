...
for make, models in cars.items():  # changed iteritems() to items()
    for model in models:
        ...
        # # Filter / plot results
        analyzer = Analyzer(file_path=r".\Data\\", file_name="HondaCivic_RochesterCraigslist.csv")
        ...
        analyzer.get_best_cars(filter_by='Age', n_iter=0, plot_show=True)  # filtered_data=filtered_data